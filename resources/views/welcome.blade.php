...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Navbar */
        .navbar { background: rgba(10,11,26,0.97); backdrop-filter: blur(20px); border-bottom: 1px solid rgba(255,255,255,0.08); padding: 1rem 0; position: sticky; top: 0; z-index: 1000; }
        ...
        /* Hero */
        .hero { min-height: 90vh; display: flex; align-items: center; background: radial-gradient(ellipse at 65% 45%, rgba(123,47,247,0.28) 0%, transparent 55%), radial-gradient(ellipse at 15% 75%, rgba(0,212,255,0.16) 0%, transparent 50%); padding: 5rem 0; }
        ...
        /* Demo validator */
        .demo-box { background: rgba(19,19,42,0.9); border: 1px solid rgba(255,255,255,0.12); border-radius: 16px; padding: 2rem; }
        .demo-input { background: rgba(255,255,255,0.07); border: 1px solid rgba(255,255,255,0.14); color: #fff; border-radius: 10px; padding: 0.875rem 1.25rem; font-size: 1rem; width: 100%; outline: none; transition: border-color 0.2s; }
        .demo-input:focus { border-color: #7b2ff7; background: rgba(255,255,255,0.1); }
        ...
        .result-card { background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 1.25rem; margin-top: 1rem; display: none; }
        ...
        /* Features */
        .features { padding: 5rem 0; background: rgba(255,255,255,0.015); }
        .features h2 { font-size: 2.2rem; font-weight: 800; text-align: center; margin-bottom: 3rem; }
        .feature-card { background: rgba(19,19,42,0.8); border: 1px solid rgba(255,255,255,0.09); border-radius: 16px; padding: 2rem; height: 100%; transition: transform 0.2s, border-color 0.2s; }
        .feature-card:hover { transform: translateY(-4px); border-color: rgba(123,47,247,0.45); background: rgba(25,25,50,0.9); }
        ...
        /* Pricing */
        .pricing { padding: 5rem 0; background: rgba(123,47,247,0.05); }
        .pricing h2 { font-size: 2.2rem; font-weight: 800; text-align: center; margin-bottom: 0.5rem; }
        .plan-card { background: rgba(19,19,42,0.8); border: 1px solid rgba(255,255,255,0.09); border-radius: 16px; padding: 2rem; text-align: center; height: 100%; transition: all 0.3s; }
        .plan-card:hover { background: rgba(25,25,50,0.9); transform: translateY(-3px); }
        .plan-card.featured { background: linear-gradient(135deg, rgba(123,47,247,0.22), rgba(0,212,255,0.08)); border-color: rgba(123,47,247,0.5); transform: scale(1.02); }
        .plan-price { font-size: 2.5rem; font-weight: 900; }
        .plan-period { font-size: 0.9rem; color: rgba(255,255,255,0.55); }
        .plan-feature { padding: 0.4rem 0; border-top: 1px solid rgba(255,255,255,0.08); font-size: 0.9rem; color: rgba(255,255,255,0.8); }
        /* Stats */
        .stats { padding: 4rem 0; background: rgba(0,212,255,0.03); }
        .stat-number { font-size: 2.8rem; font-weight: 900; }
        /* Footer */
        footer { background: rgba(5,5,15,0.6); border-top: 1px solid rgba(255,255,255,0.08); padding: 2.5rem 0; }
    </style>
</head>
<body>
